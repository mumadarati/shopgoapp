...
class _EditAddressScreenState extends State<EditAddressScreen> {
  ...
  setInfo() async {
    ...
    Billing? userBillingInfo = commonController.customerDetail.value.billing;
    addressTitleController.text = userBillingInfo!.company!;
    cityController.text = userBillingInfo.city!;
    stateController.text = userBillingInfo.state!;
    postalcodeController.text = userBillingInfo.postcode!;
    addressController.text = userBillingInfo.address1!;
    address2Controller.text = userBillingInfo.address2!;
    phoneController.text = userBillingInfo.phone!;
          ...
          children: [
            Center(
              child: _textUtils.bold18(
                  "Edit Address".tr, ColorUtils.purpleColor, TextAlign.center),
            ),
            ...
            InkWell(
              onTap: () {
                if (countryDropdownvalue == null) {
                  ...
                  _appUtils.showToast("State can not be left blank".tr);
                } else if (!(postalcodeController.text.length == 5) &&
                    !(postalcodeController.text.length == 7)) {
                  _appUtils.showToast("Wrong Postal Code".tr);
              ...
              child: Container(
                ...
                child: _textUtils.medium14(
                    "Edit Address", ColorUtils.whiteColor, TextAlign.center),
              ),
            ),
            const SizedBox(height: 20),
          ],
